...
(function () {
  ...
  var GM_DOC = [[["tbl",0],["p","r",10.0,"(신문용지 54g/㎡)"]],[["p","j",12.0,"<별지>"],["tbl",1],["p","c",12.0,"※ 범위제한의 구체적 내용 (예: 열람 가, 등사 불가 또는 등사허가 범위) 등을 비고란에 기재"]],[["p","j",10.0,"[별지 서식]"],["tbl",2],["p","j",10.0,"23231-53211일										    210㎜×297㎜"],["p","j",10.0,"98. 2. 25. 승인										 (신문용지 54g/㎡)"]],[["p","c",20.0,"서 약 서"],["p","l",11.0,"    귀 청  [b] 소송기록을 열람 또는 등사함에 있어, 형사소송법 제266조의 16 및 형사소송법 제59조의2 제5항에 따라"],["p","l",11.0,"- 열람 또는 등사에 의하여 알게 된 사항을 당해 사건 또는 관련 소송의 준비에"],["p","l",11.0,"  사용할 목적이 아닌 다른 목적으로 다른 사람에게 교부 또는 제시(전기통신"],["p","l",11.0,"  설비를 이용하여 제공하는 것을 포함한다)하지 않을 것과"],["p","l",11.0,"- 공공의 질서 또는 선량한 풍속을 해하거나 피고인의 개선 및 갱생을 방해"],["p","l",11.0,"  하거나 사건관계인의 명예 또는 생활의 평온을 해하는 행위를 하지 아니할"],["p","l",11.0,"  것을 서약합니다."],["p","l",11.0,""],["p","l",11.0,"[f]"],["p","l",11.0,"주 소(전화) :  인천 미추홀구 한나루로 436, 501호(두원빌딩)"],["p","l",11.0,"주민등록번호(생년월일) :  [a-1]"],["p","l",11.0,"성      명 :  법무법인 정서"],["p","l",14.0,"             변호사   [a]   (서명 또는 날인)"],["p","l",10.0,""],["p","j",20.0,"[g] 검사장 귀하   "]],[["p","c",20.0,"서 약 서"],["p","l",11.0,"    귀 청  2026형제36763 소송기록을 열람 또는 등사함에 있어, 형사소송법 제266조의 16 및 형사소송법 제59조의2 제5항에 따라"],["p","l",11.0,"- 열람 또는 등사에 의하여 알게 된 사항을 당해 사건 또는 관련 소송의 준비에"],["p","l",11.0,"  사용할 목적이 아닌 다른 목적으로 다른 사람에게 교부 또는 제시(전기통신"],["p","l",11.0,"  설비를 이용하여 제공하는 것을 포함한다)하지 않을 것과"],["p","l",11.0,"- 공공의 질서 또는 선량한 풍속을 해하거나 피고인의 개선 및 갱생을 방해"],["p","l",11.0,"  하거나 사건관계인의 명예 또는 생활의 평온을 해하는 행위를 하지 아니할"],["p","l",11.0,"  것을 서약합니다."],["p","l",11.0,""],["p","l",11.0,""],["p","l",11.0,"[f]"],["p","l",11.0,"주 소(전화) :  인천 미추홀구 한나루로 436, 501호(두원빌딩)"],["p","l",11.0,"주민등록번호(생년월일) :  [g-1]"],["p","l",11.0,"성      명 : [g]  (서명 또는 날인)"],["p","l",11.0,""],["p","l",10.0,""],["p","j",20.0,"[g] 검사장 귀하   "]],[["p","c",32.0,"위 임 장"],["p","j",11.0,""],["p","j",13.0,"  귀 청  2026형제36763 증거기록에 대한 열람·등사함에 있어, 사건기록 열람·등사의 방법 및 수수료 등에 관한 규칙 제4조(열람·등사의 방법) 제3항에 의거 아래 수임인에게 증거기록의 열람·등사에 관하여 위임함."],["p","j",13.0,""],["p","c",20.0,"- 수 임 인 -  "],["p","j",13.0,"	○ 성    명 :  [g]"],["p","j",13.0,"	○ 생년월일 :  [g-1]"],["p","j",13.0,"	○ 연 락 처 :  032) 868-7676"],["p","j",13.0,""],["p","j",13.0," 붙임 : 사무원증.   끝."],["p","l",13.0,"   "],["p","c",13.0,"[f]"],["p","c",13.0,""],["p","c",13.0,""],["p","r",13.0,"                       위 임 인 : 법무법인 정서"],["p","r",13.0," 변호사 [a] (서명 또는 날인)"],["p","r",13.0,""],["p","l",10.0,""],["p","l",10.0,""],["p","j",20.0,"[g] 검사장 귀하  "]]];
  ...
  // 문단 블록 1개 렌더 (['p', ha, pt, text])
  function renderPara(b, tok) {
    var fs = b[2] ? ('font-size:' + b[2] + 'pt;') : '';
    var content = wrapSign(fillTokens(esc(b[3]), tok));
    if (content === '') content = ' ';   // 빈 문단도 한 줄 높이 유지(원본 여백)
    return '<div class="gm-para" style="text-align:' + (HAMAP[b[1]] || 'left') + ';' + fs + '">' +
      content + '</div>';
  }
  ...
  function renderGeomchal(v) {
    ...
    return GM_DOC.map(function (page) {
      return '<div class="gm-page">' + page.map(function (b) {
        return (b[0] === 'tbl') ? renderTable(GM_TBL[b[1]], tok) : renderPara(b, tok);
      }).join('') + '</div>';
    }).join('');
  }
  ...
  var GM_CSS =
      ...
      /* 문단(서약서·위임장 등 표 밖 텍스트) */
      '.gm-para{white-space:pre-wrap;line-height:1.9;font-size:10pt;word-break:keep-all;tab-size:6;-moz-tab-size:6;}' +
      /* 서명란 클릭-날인 */
