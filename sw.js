...
const CACHE = 'jeongseo-v76';
const ASSETS = ['./', './index.html', './styles.css', './dojang.html', './manifest.json', './icon-192.png', './icon-512.png', './watermark.png', './firm-stamp.png', './gyeongyu.js', './fonts/PretendardVariable.woff2'];
