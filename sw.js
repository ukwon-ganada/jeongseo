...
const CACHE = 'jeongseo-v110';
const ASSETS = ['./', './index.html', './styles.css', './dojang.html', './manifest.json', './favicon.png', './logo-sidebar.png', './icon-192.png', './icon-512.png', './watermark.png', './firm-stamp.png', './gyeongyu.js', './autofill.js', './yeollam.js', './home.js', './criminal.jpg', './civil.jpg', './family.jpg', './fonts/PretendardVariable.woff2', './fonts/NotoSansKR-Regular.woff2', './fonts/NotoSansKR-Bold.woff2'];
