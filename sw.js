...
const CACHE = 'jeongseo-v232';
// 실제 존재하는 파일만. (없는 파일이 하나라도 섞이면 예전 방식(addAll)은 통째로 실패했음)
const ASSETS = ['./', './index.html', './styles.css', './dojang.html', './manifest.json', './favicon.png', './logo-sidebar.png', './icon-192.png', './icon-512.png', './watermark.png', './firm-stamp.png', './util.js', './fsdoc.js', './lawyers.js', './contractreg.js', './gyeongyu.js', './autofill.js', './hwpxfill.js', './yeollam.js', './hangso.js', './gukseon.js', './gsmgr.js', './pankyul.js', './geoljae.js', './yeongi.js', './chamgo.js', './agreement.js', './home.js', './auth.js', './criminal.jpg', './civil.jpg', './family.jpg', './fonts/NotoSansKR-400.woff2', './fonts/NotoSansKR-500.woff2', './templates/hangso.hwpx', './templates/sanggo.hwpx', './templates/yeollam_court.hwpx', './templates/yeollam_prosecution.hwpx', './templates/pankyul.hwpx', './templates/minga_hangso.hwpx', './templates/minga_sanggo.hwpx', './templates/chamgo.hwpx', './templates/agreement.hwpx', './templates/yeongi_criminal.hwpx', './templates/yeongi_civil_consent.hwpx', './templates/yeongi_civil_dissent.hwpx', './templates/yeongi_bojeong.hwpx'];
