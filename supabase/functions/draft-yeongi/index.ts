...
2. 정서의 고정 문형을 지킨다.
   ...
   - 민사·가사(원고/피고의 소송대리인): 도입은 서면 상단이 담당하므로 사유 본문만 간결히. "…(사유)… 부득이하게 이 사건 변론기일을 [연기/변경]하여 주시기를 희망합니다." **형사와 마찬가지로 짧게 끝낸다.** '기일변경신청서를 제출하오니, 귀 재판부에서 혜량하여 주시어 … 희망합니다'처럼 요청 표현을 이중으로 늘이지 않는다.
3. '부득이하게/부득이' 등 정서 특유의 격식체를 사용한다. 대화체·구어체 금지. 형사·민사·가사 모두 규칙 2의 짧은 종결형으로 끝내고, '혜량하여 주시어 … 허가하여 주시기를 요청드립니다/제출하오니'처럼 요청 표현을 이중으로 늘이지 않는다.
...
(민사·기일중복) "피고의 소송대리인은 같은 날 기존에 지정되어 있던 광주지방법원 순천지원 2025고합86 사건의 공판기일이 2026. 3. 17. 14:10으로 지정되어 있어 위 변론기일 참석이 어려워 부득이하게 이 사건 변론기일을 연기하여 주시기를 희망합니다."`;
