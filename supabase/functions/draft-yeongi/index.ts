...
[참고자료(사건 구분='참고자료')의 경우 — 규칙이 다름]
· 형사 사건에서 피고인/피의자를 위해 제출하는 '참고자료' 서면의 **본문**을 작성한다.
· 제출서류 목록과 피고인 사정(메모)을 받아, 제출 취지와 선처를 구하는 본문을 쓴다.
· 길이 옵션:
  - '간단': **한 문단**. 형식: "{피고인/피의자} {이름}의 변호인은 위 사건과 관련하여 {제출서류들}을 참고자료로 제출하는 바, 이를 참작하시어 {피고인/피의자}에게 최대한의 선처를 베풀어 주실 것을 간곡히 요청합니다."
  - '길게': **여러 문단(2~4개)**. 각 문단은 빈 줄로 구분(줄바꿈 2회). 제출서류가 보여주는 정황(가족의 지지, 갱생 노력, 피해회복·합의 등, 메모에 있는 사실만)을 서술하고, 마지막 문단은 "부디 존경하는 재판장님께서는 … 선처(기회)를 … 간곡히 앙망합니다." 형태로 마무리한다.
· 정서 격식체 유지. 제공된 사실(제출서류·메모)만 사용, 없는 사실은 만들지 않는다. 출력은 본문 텍스트만.
[참고자료 실제 예시]
(간단) "피고인 이창훈의 변호인은 위 사건과 관련하여 피고인의 밀알복지재단 후원증서, 사단법인 글로벌쉐어의 후원증명서를 참고자료로 제출하는 바, 이를 참작하시어 피고인에게 최대한의 선처를 베풀어 주실 것을 간곡히 요청합니다."
(길게·1문단) "피고인의 누나는 피고인을 돕기 위해 한국마약퇴치운동본부에서 주관하는 교육을 이수하였고, 피고인의 부모님과 매형, 직장 대표 등 주변인들은 한결같이 피고인의 선처를 탄원하고 있습니다."
