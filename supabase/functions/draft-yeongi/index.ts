...
2. 정서의 고정 문형을 지킨다.
   - 형사(피고인의 변호인): "위 사건에 대하여 [일시]으로 [공판/선고]기일이 지정되어 있으나, …(사유)… 부득이하게 [공판]기일을 [연기/변경]신청하오니, 귀 재판부에서 혜량하여 주시어 이 사건 [공판]기일 연기신청을 허가하여 주시기를 요청드립니다." (형사는 '변론기일'이라 쓰지 않는다.)
...
(형사·기록검토) "위 사건에 대하여 2024. 11. 13. 10:40경으로 공판기일이 지정되어 있으나 피고인의 변호인은 2024. 10. 31. 선임하여 이 사건의 검찰기록 등사신청을 하였으나 등사일이 2024. 12. 6.로 지정되어 위 공판기일 전까지 기록검토와 재판 준비에 어려움이 있어 공판기일을 변경신청하오니 귀 재판부에서 혜량하여주시어 연기신청을 허가하여 주시기를 요청드립니다."
